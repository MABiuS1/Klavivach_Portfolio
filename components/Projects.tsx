...
const projects = [
  {
    ...
    title: "Sport Complex",
    description: "This is my college project booking system built using Go and Next.js using Microservices.",
  ...
  },
  {
    ...
    description: "A weather forecast application developed using Spring Boot, Java, and JSP during my 2nd year. It provides current weather updates and a 5-day forecast.",
  ...
  },
  {
    ...
    description: "This project is licensed under the How to Live and Learn on Campus Developer Team only.",
  ...
  },
  {
    ...
    description: "Yakkaw is a modern mobile application designed to monitor air pollution issues in Thailand, starting from Chiang Rai and expanding to northern provinces. It provides real-time PM2.5 air quality data, interactive maps, and health-based recommendations.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mt-8">
          ...
          <div
            ...
            className="overflow-x-auto hide-scrollbar flex space-x-6 pb-8 px-4 scroll-smooth"
          >
            {projects.map((project, index) => (
              <motion.div
                key={index}
                className="min-w-[340px] bg-white dark:bg-gray-800 rounded-xl shadow-lg flex-shrink-0 overflow-hidden hover:shadow-xl transition-shadow duration-300"
